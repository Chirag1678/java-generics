...
// abstract class to define a job role
...
class DataScientist extends JobRole {
    public DataScientist() {
        super("Data Scientist", "Expertise in machine learning and data analysis");
    }

    @Override
    public void getRoleDetails() {
        System.out.println("Data Scientist: Requires expertise in machine learning and data analysis.");
    }
}
...
class ProductManager extends JobRole {
    public ProductManager() {
        super("Product Manager", "Strategic thinking and leadership skills");
    }

    @Override
    public void getRoleDetails() {
        System.out.println("Product Manager: Requires strategic thinking and leadership skills.");
    }
}